...
export function SiteShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.16),transparent_28rem),linear-gradient(135deg,#090b0f_0%,#101217_54%,#050607_100%)] text-zinc-50">
      ...
      <footer className="mx-auto flex min-h-16 w-full max-w-6xl flex-col justify-center gap-2 px-5 py-4 font-mono text-xs text-zinc-500 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10">
        <span>MIT licensed · github.com/elvisun/newsjack</span>
        <Link
          className="w-fit text-zinc-400 transition hover:text-emerald-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-emerald-300"
          href="/ethics"
        >
          Ethics
        </Link>

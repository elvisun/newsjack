...
| coarse_relevance | pending - coarse_relevance_decisions.json |
| relevance_apply | pending - relevant_candidates.json |
| story_origin | pending - origin_findings.json |
| freshness_gate | pending - targeted_candidates.json |

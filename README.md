...
newsjack is an open-source agent skill for PR work. Install it once on Claude, ChatGPT, Cursor, or any agent runtime that supports skills — your agent becomes a PR operator.

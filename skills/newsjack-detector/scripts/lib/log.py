"""Shared logging utilities for newsjack skill."""

import os
import sys

DEBUG = os.environ.get("NEWSJACK_DEBUG", "").lower() in ("1", "true", "yes")


def debug(msg: str) -> None:
    """Log debug message to stderr (only when NEWSJACK_DEBUG is set)."""
    if DEBUG:
